...
jQuery(document).ready(function($) {
  ...
  $('.js-btn-open-video').click(function(event) {
    ...
    $('.overlay').fadeIn(400, function() {
      $('.js-show-modal-video ').css('display', 'block').animate({
        opacity: 1,
        top: '0'
      }, 200);
    });
  ...
  $('.js-btn-open-todo').click(function(event) {
    ...
    event.preventDefault();
    $('.overlay').fadeIn(400, function() {
      $('.js-show-modal-todo ').css('display', 'block').animate({
        opacity: 1,
        top: '45%'
      }, 200);
    });
  ...
  $('.js-btn-open-menu').click(function(event) {
    ...
    if ($('.js-btn-open-menu').hasClass('open')) {
      ...
      $('.overlay').fadeIn(400, function() {
        $('.js-show-modal-menu ').css('display', 'block').animate({
          opacity: 1,
          top: '0'
        }, 200);
  ...
  $('.js-btn-close-modal, .overlay').click(function() {
    $('.js-show-modal-todo, .js-show-modal-menu , .js-show-modal-video').animate({
      opacity: 0,
      top: '45%'
    }, 200, function() {
      $(this).css('display', 'none');
  ...
  function runPosBtnClose() {
    ...
    var $def = $.Deferred();
    setTimeout(function() {
      /* console.log($('#swipebox-slider').find('.current img')["0"])*/
      if ($('#swipebox-slider').find('.current img')["0"] != undefined) {
